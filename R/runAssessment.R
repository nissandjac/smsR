...
#'
#' @param df.tmb A list generated by the `get_tmb_parameters` containing model input data and configuration
#' @param parms A list or object generated by the `getParms` function, containing
...
#' @param save_all save all output or keep just SSB, R, Catch, and biomass
#' @param debug Use debugger to report output from initial parameters
#'
#' @return An smsR object containing:
#' \describe{
#'   \item{\code{opt}}{A list of estimated parameters from `nlminb` function.}
#'   \item{\code{reps}}{Output from the `sdreport` TMB function that contains standard deviations and hessian of model fit}
#'   \item{\code{obj}}{TMB object from `MakeADFun`. Contains the output using the initial parameter set}
#'   \item{\code{dat}}{Input data file `df.tmb` for export}
#' }
#'
#' @details
